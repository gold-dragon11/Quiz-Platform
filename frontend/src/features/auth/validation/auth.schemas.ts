...
const username = z
  .string()
  .trim()
  .min(3, 'Імʼя користувача має містити щонайменше 3 символи')
  .max(30, 'Імʼя користувача має містити не більше 30 символів')
  .regex(/^[A-Za-z0-9_]+$/, 'Імʼя користувача може містити лише латинські літери, цифри та підкреслення');
