...
/**
 * Recent Activity (docs/01-prd/dashboard.md §8): the newest completed quiz
 * sessions from GET /statistics/recent (already newest-first). Shows an
 * encouraging empty state for users with no completed quizzes yet (§10).
 */
